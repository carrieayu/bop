...
min_max_validator = [ MinValueValidator(min_int), MaxValueValidator(max_int) ] 
...
class CostOfSales(models.Model):
    ...
    year = models.CharField(max_length=4, default="2001",choices=YEAR_CHOICES ) # Only (2000 - 2101) Range Accepted.)
    month = models.CharField(max_length=2, default="01", choices=MONTH_CHOICES ) # Only (01 - 12) Range Accepted.
    purchase = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    outsourcing_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    product_purchase = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    dispatch_labor_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    communication_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    work_in_progress_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    amortization_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    class Meta :
...
class Expenses(models.Model):
    ...
    rent_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    tax_and_public_charge = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    depreciation_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    travel_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    communication_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    utilities_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    transaction_fee = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    advertising_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    entertainment_expense = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    professional_service_fee = models.DecimalField(validators=min_max_validator, max_digits=MAX_DIGITS, decimal_places=DECIMAL_PLACES)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    class Meta :
        db_table = u'expenses'
