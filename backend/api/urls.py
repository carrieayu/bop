...
urlpatterns = [
    ...
    path("business-divisions/", views.CompaniesWithBusinessDivisions.as_view(), name="companies-with-business-division"), #url for filtering the business division from the selected company
