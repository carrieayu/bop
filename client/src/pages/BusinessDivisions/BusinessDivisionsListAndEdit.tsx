  ...
  return (
    <div className='BusinessDivisionsListAndEdit_wrapper'>
      ...
      <div className='BusinessDivisionsListAndEdit_cont_wrapper'>
        <div className='BusinessDivisionsListAndEdit_sidebar'>
          <Sidebar />
        </div>
                          ...
                          <table className='table is-bordered is-hoverable'>
                            ...
                            <tbody className='BusinessDivisionsListAndEdit_table_body'>
                              {/* {projects.map((project, index) => ( */}
                                <tr key='{project.planning_project_id}' className='BusinessDivisionsListAndEdit_table_body_content_horizantal'>
