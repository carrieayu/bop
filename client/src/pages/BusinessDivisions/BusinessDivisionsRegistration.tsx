...
const BusinessDivisionsRegistration = () => {
    ...
    useEffect(() => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post('http://127.0.0.1:8000/api/master-business-divisions/create/', postData, {
          // const response = await axios.post('http://54.178.202.58:8000/api/master-business-divisions/create/', postData, {
            headers: {
      ...
      useEffect(() => {
        const fetchCompany = async () => {
          try{
            const response = await axios.get('http://127.0.0.1:8000/api/master-companies/list/', {
            // const response = await axios.get('http://54.178.202.58:8000/api/master-companies/list/', {
              headers: { 
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}` 
              },
