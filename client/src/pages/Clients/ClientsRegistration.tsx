...
const ClientsRegistration = () => {
    ...
    useEffect(() => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post('http://127.0.0.1:8000/api/master-clients/create/', client, {
            // const response = await axios.post('http://54.178.202.58:8000/api/master-clients/create/', client, {
            headers: {
