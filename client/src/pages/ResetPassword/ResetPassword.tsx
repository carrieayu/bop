...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`http://127.0.0.1:8000/api/password-reset/${uid}/${token}/`, {
        // const response = await axios.put(`http://54.178.202.58:8000/api/password-reset/${uid}/${token}/`, {
        password,
      })
