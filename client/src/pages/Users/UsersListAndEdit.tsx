...
const UsersListAndEdit: React.FC = () => {
  ...
  const handleSubmit = async () => {
      ...
      try {
        const response = await axios.put('http://127.0.0.1:8000/api/users/update/', userList, {
          // const response = await axios.put('http://54.178.202.58:8000/api/users/update/',  userList ,{
          headers: {
      ...
      const fetchProjects = async () => {
        ...
        try {
          const response = await axios.get('http://127.0.0.1:8000/api/users/list/', {
            // const response = await axios.get('http://54.178.202.58:8000/api/users/list/', {
          })
    ...
    const handleConfirm = async () => {
      ...
      const token = localStorage.getItem('accessToken')
      try {
        const response = await axios.delete(`http://127.0.0.1:8000/api/users/list/${deleteId}/delete/`, {
          // const response = await axios.get(`http://54.178.202.58:8000/api/users/list/${deleteId}/delete/`, {
        })
