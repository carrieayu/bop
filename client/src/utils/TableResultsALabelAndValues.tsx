...
export const resultsTableALabelsAndValues = (results, resultsCalculations) => { 
    ...
    const labelsAndValuesResults = [
        ...
        { label: 'bonusAndFuelAllowance', values: results.employeeExpenses.individualMonthlyTotals.bonusAndFuelAllowance },
        { label: 'statutoryWelfareExpenses', values: results.employeeExpenses.individualMonthlyTotals.statutoryWelfareExpense },
        { label: 'welfareExpenses', values: results.employeeExpenses.individualMonthlyTotals.welfareExpense },
        ...
        { label: 'consumableExpenses', values: results.expenses.individualMonthlyTotals.consumableExpense },
        { label: 'rentExpenses', values: results.expenses.individualMonthlyTotals.rentExpense },
        { label: 'taxesAndPublicCharges', values: results.expenses.individualMonthlyTotals.taxAndPublicCharge },
        ...
        { label: 'utilitiesExpenses', values: results.expenses.individualMonthlyTotals.utilitiesExpense },
        ...
        { label: 'professionalServicesFees', values: results.expenses.individualMonthlyTotals.professionalServicesFee },
